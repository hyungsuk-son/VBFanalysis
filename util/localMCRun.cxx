...
int main( int argc, char* argv[] ) {
  ...
  //SH::ScanDir().filePattern("DAOD_EXOT5.07992585._0*").scan(sh,inputFilePath); // MC run 363395
  SH::ScanDir().filePattern("DAOD_EXOT5.07992585._000012.pool.root.1").scan(sh,inputFilePath); // MC run 363397
